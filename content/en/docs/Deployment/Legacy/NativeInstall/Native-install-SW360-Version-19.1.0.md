---
linkTitle: "Native-Install v19.1"
title: "Native Install v19.1"
weight: 100
description: 
  Native-Install-Version-19.1
---

# How to install and run SW360 v19.1.0
...
This material helps user to install SW360 19.1.0 
...
## 3. Native install 19.1.0 (without docker-compose)
...
- [3.4 Clone Project sw360 with version 19.1.0](#ref4)

- [3.5 Install Thrift version 16.0](#ref5)

- [3.6 Config properties files with Sw360 (sw360 19.1.0)](#ref6)

- [3.7 Compile and deploy](#ref7)

- [3.8 Version Management Table (sw360 19.1.0)](#ref8)
...
* Copy content from  https://github.com/eclipse/sw360/blob/sw360-19.1.0-M1/frontend/configuration/portal-ext.properties to portal-ext.properties
